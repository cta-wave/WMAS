...
const REFERENCE_BROWSERS = {
  'chrome63': {
    name: 'Chrome 63',
    url: 'https://s3.us-east-2.amazonaws.com/wave-browser-snapshots/wave-reference-browser-results/Chrome63-ce4aec10-7855-11e8-b81b-6714c602f007.zip'
  },
  'edge16': {
    name: 'Edge 16',
    url: 'https://s3.us-east-2.amazonaws.com/wave-browser-snapshots/wave-reference-browser-results/Edge16-01d11810-7938-11e8-8749-a6ac1d216fc7.zip'
  },
  'firefox57': {
    name: 'Firefox 57',
    url: 'https://s3.us-east-2.amazonaws.com/wave-browser-snapshots/wave-reference-browser-results/Firefox57-a831a820-7855-11e8-9ce0-d6175576bb4b.zip'
  },
  'safari11': {
    name: 'Safari 11',
    url: 'https://s3.us-east-2.amazonaws.com/wave-browser-snapshots/wave-reference-browser-results/Safari11-62b61630-7938-11e8-b48e-f58ca22000c9.zip'
  },
  'webkit604': {
    name: 'WebKit 604',
    url: 'https://s3.us-east-2.amazonaws.com/wave-browser-snapshots/wave-reference-browser-results/WebKit604-c0cdb6c0-7b99-11e8-939a-90ffd3c0ec6f.zip'
  }
}
...
;(async () => {
  const { applicationDirectoryPath, configurationFilePath, operation } = getRunParameters()
...
async function downloadReferenceResults(applicationDirectoryPath) {
  const DOWNLOAD_PATH = path.normalize(path.join(applicationDirectoryPath, '../../results'))
