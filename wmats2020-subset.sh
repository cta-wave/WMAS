...
git remote add origin https://github.com/web-platform-tests/wpt.git 2>1 1>/dev/null
git fetch origin 2>1 1>/dev/null
...
# DOM [DOM]
git checkout 5fb2692263f71ff8cb1b8af8349c3873d69e6ba5 dom 2>1 1>/dev/null
mv dom $WPTBASEDIR
...
git checkout 02ebfda73367c0419e19f83048fa5895a78cb418 webmessaging 2>1 1>/dev/null
mv webmessaging $WPTBASEDIR
git checkout a7ff355e88929913036932ed16598b4682541d59 webstorage 2>1 1>/dev/null
mv webstorage $WPTBASEDIR
git checkout 59873545965cc737221c40c4004f2a3c9ce23f28 workers 2>1 1>/dev/null
...
git checkout 35979641de0b29313f7f28ab352d380186754ecd css/CSS2 2>1 1>/dev/null
mv css $WPTBASEDIR

# Compositing and Blending Level 1 [COMPOSITING]
git checkout 5d0dcf0142d07916584db9c76c2fdec02833e959 css/compositing 2>1 1>/dev/null
mv css/compositing $WPTBASEDIR/css

# CSS Animations [CSS3-ANIMATIONS]
git checkout f6acb6c0316cabf895c8c47dc654e77ef4b2a287 css/css-animations 2>1 1>/dev/null
mv css/css-animations $WPTBASEDIR/css

# CSS Backgrounds and Borders Module Level 3 [CSS3-BACKGROUND]
git checkout 398cdfa444185dda88ca6e87fb12096bc8a82199 css/css-backgrounds 2>1 1>/dev/null
mv css/css-backgrounds $WPTBASEDIR/css

# CSS Basic User Interface Module Level 3 (CSS3 UI) [CSS-UI-3]
git checkout 545c96ead1616661ce2e97b66450efcf1b032851 css/css-ui 2>1 1>/dev/null
mv css/css-ui $WPTBASEDIR/css

# CSS Cascading and Inheritance Level 3 [CSS-CASCADE-3]
git checkout 9ad6ebf9fff00dcd46d6c5438ebbd0f7e71c15f8 css/css-cascade 2>1 1>/dev/null
mv css/css-cascade $WPTBASEDIR/css

# CSS Color Module Level 3 [CSS3-COLOR]
git checkout b6e84edf4a398cc48f4983cbd8398858816996ae css/css-color 2>1 1>/dev/null
mv css/css-color $WPTBASEDIR/css

# CSS Conditional Rules Module Level 3 [CSS3-CONDITIONAL]
git checkout 01bda5c03bf8ae4ee00251b8969adf1ef69f443d css/css-conditional 2>1 1>/dev/null
mv css/css-conditional $WPTBASEDIR/css

# CSS Custom Properties For Cascading Variables Module Level 1 [CSS-VARIABLES-1]
git checkout b1f24df9a2e449e0545bf6d74b62c0a40c543fde css/css-variables 2>1 1>/dev/null
mv css/css-variables $WPTBASEDIR/css

# CSS Easing Functions Level 1 [CSS-EASING-1]
git checkout 9f47205824fa25eca5d9ab2c87a016a7c5c4df3a css/css-easing 2>1 1>/dev/null
rm -rf css/css-easing/**/*step*
mv css/css-easing $WPTBASEDIR/css

# CSS Flexible Box Layout Module Level 1 [CSS-FLEXBOX-1]
git checkout 9d6f1c1aa7e1daa62c350b3fec18d594792f408a css/css-flexbox 2>1 1>/dev/null
mv css/css-flexbox $WPTBASEDIR/css

# CSS Fonts Module Level 3 [CSS-FONTS-3]
git checkout 3d83b8688bbd6d9e2a7fc31021bc214cbf0ebcb7 css/css-fonts 2>1 1>/dev/null
mv css/css-fonts $WPTBASEDIR/css

# CSS Grid Layout Module Level 1 [CSS-GRID-1]
git checkout 8c317250a78e2bd178373528a1e61d550485159d css/css-grid 2>1 1>/dev/null
mv css/css-grid $WPTBASEDIR/css

# CSS Image Values and Replaced Content Module Level 3 [CSS3-IMAGES]
git checkout 0624a18c9ebc3cc710d1e54dfd5adb5a0a829c42 css/css-images 2>1 1>/dev/null
mv css/css-images $WPTBASEDIR/css

# CSS Multi-column Layout Module [CSS3-MULTICOL]
git checkout c0b406d151940c4253d59c041d895e763c27e754 css/css-multicol 2>1 1>/dev/null
mv css/css-multicol $WPTBASEDIR/css

# CSS Namespaces Module Level 3 [CSS-NAMESPACES-3]
git checkout 29f50c937e8be8ccf73dbb8b8e74f0668a1cd426 css/css-namespaces 2>1 1>/dev/null
mv css/css-namespaces $WPTBASEDIR/css

# CSS Scroll Snap Module Level 1 [CSS-SCROLL-SNAP-1]
git checkout 546f149c579b3c78422d1f998b56edf73b5cfedc css/css-scroll-snap 2>1 1>/dev/null
mv css/css-scroll-snap $WPTBASEDIR/css

# CSS Shapes Module Level 1 [CSS-SHAPES-1]
git checkout 1cae03c4c11acf12fe20722e5eda3513df9dd79c css/css-shapes 2>1 1>/dev/null
mv css/css-shapes $WPTBASEDIR/css

# CSS Style Attributes [CSS-STYLE-ATTR]
git checkout a5f707c18b3d893a6e332994064911c2f11e800d css/css-style-attr 2>1 1>/dev/null
mv css/css-style-attr $WPTBASEDIR/css

# CSS Syntax Module Level 3 [CSS-SYNTAX-3]
git checkout 3696f2233a37437896505b7187968aa605be9255 css/css-syntax 2>1 1>/dev/null
mv css/css-syntax $WPTBASEDIR/css

# CSS Text Decoration Module Level 3 [CSS-TEXT-DECOR-3]
git checkout c04dd6a79ab11d2c8cf5e0c69848d7b518a30b76 css/css-text-decor 2>1 1>/dev/null
rm -rf css/css-text-decor/**/*text-emphasis*
mv css/css-text-decor $WPTBASEDIR/css

# CSS Transforms Module Level 1 [CSS-TRANSFORMS-1]
git checkout 5f0da8e0ee156d0561ebcb9c9304dedd06119bd8 css/css-transforms 2>1 1>/dev/null
mv css/css-transforms $WPTBASEDIR/css

# CSS Transitions [CSS3-TRANSITIONS]
git checkout 2ed850a370f099478001a7ae6bb765d38dab8057 css/css-transitions 2>1 1>/dev/null
mv css/css-transitions $WPTBASEDIR/css

# CSS Values and Units Module Level 3 [CSS-VALUES]
git checkout 861e227caba7dc9341dd833518f0d01b1e02d0a4 css/css-values 2>1 1>/dev/null
mv css/css-values $WPTBASEDIR/css

# CSS Will Change Module Level 1 [CSS-WILL-CHANGE-1]
git checkout e5456864c2964700255ba32ea59c1aa46ad1155c css/css-will-change 2>1 1>/dev/null
mv css/css-will-change $WPTBASEDIR/css

# CSS Writing Modes Level 3 [CSS-WRITING-MODES-3] 
git checkout 6085f658ace31a3c962a69d5128cc7e66d79cbb9 css/css-writing-modes 2>1 1>/dev/null
rm -rf css/css-writing-modes/**/*text-orientation*
mv css/css-writing-modes $WPTBASEDIR/css

# CSSOM View Module [CSSOM-VIEW]
git checkout 3806bf2419e25bd57e70b42103478fd3c12a143b css/cssom-view 2>1 1>/dev/null
mv css/cssom-view $WPTBASEDIR/css

# Filter Effects Module Level 1 [FILTER-EFFECTS-1]
git checkout 98ed5928328dd2121d13752ec7c84e1e29c39f4b css/filter-effects 2>1 1>/dev/null
mv css/filter-effects $WPTBASEDIR/css

# Media Queries [CSS3-MEDIAQUERIES]
git checkout b09e7e2e78695b5e2052bfadd941de602f1e16fb css/mediaqueries 2>1 1>/dev/null
mv css/mediaqueries $WPTBASEDIR/css

# Selectors Level 3 [SELECT]
git checkout eff766e5c8c39be7b9bff064bce3a18eb2953ac5 css/selectors 2>1 1>/dev/null
...
git checkout 5845bba1671bad710561b6b6e5825989878bb44c encrypted-media 2>1 1>/dev/null
mv encrypted-media $WPTBASEDIR

# Media Source Extensions [MEDIA-SOURCE]
git checkout e0dc0f1a554ed116efa992a7095def76c58e13ee media-source 2>1 1>/dev/null
mv media-source $WPTBASEDIR

# Web Audio API [WEBAUDIO]
git checkout 6a6a92e48d907b3c5a9b2be2386aecc4e67c8b99 webaudio 2>1 1>/dev/null
...
git checkout 87cd9eb2adafed5d4c6ce08a6716927f4d4fb4ea fullscreen 2>1 1>/dev/null
...
git checkout d9a933a853acb263fe849b9fcfa0c16278d9ce08 fonts 2>1 1>/dev/null
mv fonts $WPTBASEDIR
...
# Fetch [FETCH]
git checkout 2f6111ecc1c0bc803a5287e0714f9c715023f5b9 fetch 2>1 1>/dev/null
mv fetch $WPTBASEDIR

# XMLHttpRequest [XHR]
git checkout a35aa4089a7498dd4e107828c0925823fe512c97 xhr 2>1 1>/dev/null
mv xhr $WPTBASEDIR
...
git checkout 94d018bb5d7c0d46df7ba1ac1efdbaa88bc159dc content-security-policy 2>1 1>/dev/null
mv content-security-policy $WPTBASEDIR

# Referrer Policy [REFERRER-POLICY]
git checkout cd9e10befb1edcbb7d04e06ef7255e56c72c07e8 referrer-policy 2>1 1>/dev/null
mv referrer-policy $WPTBASEDIR

# Subresource Integrity [SRI]
git checkout 8fefedccb9ae49bddd9c84d22b21177f156a561e subresource-integrity 2>1 1>/dev/null
...
git checkout b4b88e7de8f61c8c8fe1ac615fd883b3a042709f upgrade-insecure-requests 2>1 1>/dev/null
mv upgrade-insecure-requests $WPTBASEDIR

# Web Cryptography API [WEBCRYPTOAPI]
git checkout 14236258ece08c439179427a25f0a2102f5664df WebCryptoAPI 2>1 1>/dev/null
...
# Beacon [BEACON]
git checkout a341862f7bf55470eb456fbdbb20e465508e7cb9 beacon 2>1 1>/dev/null
mv beacon $WPTBASEDIR

# High Resolution Time Level 1 [HR-TIME-1]
git checkout 57747da202f050d84df2b73e5821a56b18af66f7 hr-time 2>1 1>/dev/null
mv hr-time $WPTBASEDIR

# Navigation Timing [NAVIGATION-TIMING]
git checkout df24fb604e2d40528ac1d1b5dd970e32fc5c2978 navigation-timing 2>1 1>/dev/null
mv navigation-timing $WPTBASEDIR

# Page Visibility Level 2 [PAGE-VISIBILITY-2]
git checkout df24fb604e2d40528ac1d1b5dd970e32fc5c2978 page-visibility 2>1 1>/dev/null
mv page-visibility $WPTBASEDIR

# Performance Timeline [PERFORMANCE-TIMELINE]
git checkout 561f5a515ff8c39d414581ba2906aa980591d539 performance-timeline 2>1 1>/dev/null
mv performance-timeline $WPTBASEDIR

# Resource Timing Level 1 [RESOURCE-TIMING-1]
git checkout 794e5cbf23f420cc4394207f22135344255f66aa resource-timing 2>1 1>/dev/null
mv resource-timing $WPTBASEDIR

# User Timing Level 2 [USER-TIMING-2]
git checkout df24fb604e2d40528ac1d1b5dd970e32fc5c2978 user-timing 2>1 1>/dev/null
...
git checkout b57479444fa21e2854dfb876f36f14f437ef7e35 IndexedDB 2>1 1>/dev/null
mv IndexedDB $WPTBASEDIR

# File API [FILEAPI]
git checkout 648205dcf15d75c37b7abe7a0c1a2a7128baea36 FileAPI 2>1 1>/dev/null
mv FileAPI $WPTBASEDIR

# Notifications API [NOTIFICATIONS] 
git checkout 2c5c3c4c27d27a419c1fdba3e9879c2d22037074 notifications 2>1 1>/dev/null
mv notifications $WPTBASEDIR

# Service Workers 1 [SERVICE-WORKERS-1]
git checkout b26c9dcf86ba2f91e2ea20ad72d67c0ce51b5b5d service-workers 2>1 1>/dev/null
mv service-workers $WPTBASEDIR

# UI Events [UIEVENTS]
git checkout 66ec292ee48a9a2bbfa2f556e614926cd07211aa uievents 2>1 1>/dev/null
...
git clone https://github.com/tc39/test262.git $DISTDIR 2>1 1>/dev/null
cd $DISTDIR
